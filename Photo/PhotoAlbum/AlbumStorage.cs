...
namespace PhotoAlbum
{
    ...
    public static class AlbumStorage
    {
        ...
        static public void WriteAlbum(
PhotoAlbum album, string path)
        {
        ...
        static private void WritePhoto(
StreamWriter sw, Photo p)
        {
        ...
        static public PhotoAlbum ReadAlbum(
string path)
        {
        ...
        static private void ReadAlbumV63(
StreamReader sr, PhotoAlbum album)
        {
        ...
        static private Photo ReadPhotoV63(
StreamReader sr)
        {
